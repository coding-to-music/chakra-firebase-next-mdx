        ...
        <Flex flexDir="column" w={["100%", "100%", "50%"]} mr={[0, 0, 4]}>
          ...
          >
            ...
            >
              ...
              <strong>creator 📹</strong>, and <strong>student 👨‍🎓</strong>{" "}
              living and working in CT. You've stumbled onto my online
              portfolio, resume, blog, and all things in between.
            </Text>
          </motion.div>
          <motion.div
            initial={{ y: -20, opacity: 0 }}
        ...
        <Box mt={[10, 10, 0]} w={["100%", "100%", "50%"]}>
          ...
          >
            <AspectRatio ratio={16 / 9}>
              <iframe
                src="https://www.youtube.com/embed/uNKBWrkMO_Q"
